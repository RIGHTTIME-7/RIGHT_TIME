...
<section class="w3l-services-2">
	...
	<div class="services-2-mian py-5">
        ...
        $q="select * from requests where priority=0 and closed= '0'and verified=1 and id not in(select id from responses where username='$userid') ";
        //echo $q;
        ...
        if(!$count)
        {
          $ms="No Contents Yet";
            ...
            <a data-toggle="modal" data-target="#myModal" class="btn scroll"><button>Need Help?</button></a>
...
<input type="text" name="resource" class="form-control" required placeholder="Resource" required />
 ...
 <div class="form-group">
                 <input type="text" style="visibility:hidden;" name="p" class="form-control" required placeholder="Quantity Or Value" value="0" />
 </div>
