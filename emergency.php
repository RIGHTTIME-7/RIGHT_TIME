...
<body style="overflow: hidden;">
  <div class="header">
    ...
    <div class="header-right">
      ...
      <a  href="dashboard.php">Around ME</a>
...
<section class="w3l-services-2">
	...
	<div class="services-2-mian py-5">
        ...
        $q="select * from requests where  id not in(select reqid from responses where username='$userid') and priority=1 and closed= '0'  ";
        //echo $q;
        ...
        ?>
				<div class="col-lg-4 col-md-6 course-grid" style="visibility:<?php echo $ac;?>">
					<div class="course-grid-inf">
						<a href="#"><i style="font-size:100px;color:#1E90FF" ;="" class="fa fa-bullhorn" aria-hidden="true"></i></a>
