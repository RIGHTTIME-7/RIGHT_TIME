...
$select="select * from registration where username in (select username from responses where reqid=$id)";
        ...
        <div class="container scroll">
          <table class="table isSearch" cellspacing="0">
           ...
           <tr>
             ...
             <?php echo $data['name'];?>
           </td><td class="body-item mbr-fonts-style display-7"><?php echo $data['phone'];?>
           </td><td class="body-item mbr-fonts-style display-7"><?php echo $data['localbody'];?><br><?php echo $data['district'];?><br><?php echo $data['state'];?><br><?php echo $data['zip'];?>
             </td></tr>
            <?php
          }
          ?>
