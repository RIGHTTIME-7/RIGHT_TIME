...
<body style="overflow: hidden;">
  <div class="header">
    ...
    <div class="header-right">
      ...
      <a class="dashboard.php" href="dashboard.php">Around ME</a>
      <a  href="emergency.php">Emergency Requests</a>
      <a href="requests.php">Requests</a>
        <a class="active" href="myrequests.php">My Requests</a>
...
<section class="w3l-services-2">
	...
	<div class="services-2-mian py-5">
        ...
        $q="select * from requests where  username='$userid'";
        //echo $q;
        ...
        ?>
            ...
            <a href="close.php?id=<?php echo $result['id']?>"><button  <?php echo $ty;?> class="price-course btn"> <?php echo $var;?> </button></a>
            <a href="http://localhost/righttime/table/responses.php?id=<?php echo $result['id']?>"><button class="price-course btn"> View Responses </button></a>
					</div>
				</div>
        <br>
