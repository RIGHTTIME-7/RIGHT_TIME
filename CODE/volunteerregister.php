...
<head>
  <?php
    ...
    // $_SESSION['userid']
    $i++;
    $insertq="insert into registration(username,name,email,phone,state,district,localbody,zip)values('$_POST[email]','$_POST[name]','$_POST[email]','$_POST[ph]','$_POST[state]','$_POST[district]','$_POST[lb]',$_POST[zip])";
    //echo $insertq;

    $insertdoc="insert into volunteer values('$_POST[email]','$_POST[doc]',0)";

    $insertlog="insert into login values('$_POST[email]','$_POST[password2]','v')";
  ...
  <script>
   ...
   window.location='righttime.html'
  </script>;
  <?php
...
<div class="w3-row" style="padding-left: 20px;">
 ...
 <h4 class="display-4" align="center" style="font-size: 40px;">Volunteer Registration</h4>
 <center>
...
<p class="text-danger"><?php echo $message; ?></p>
          <form method="post" action="">
           ...
           <input type="text" name="name" class="form-control" required placeholder="Full Name" required />
            ...
            <div class="form-group">
                            <input type="file" name="doc" class="form-control" required placeholder="Upload File" required />
            </div>
            <script>
            var check = function() {
            ...
            <div class="form-group">
                            <input type="password" id='p1' name="password" class="form-control" required placeholder="Password" required />
            </div>
            <div class="form-group">
                            <input type="password" id='p2' name="password2" class="form-control" required placeholder="Confirm Password" required />
            </div>
            <div id="msg" >
            </div>
            <div class="form-group">
              <input type="submit" name="sub" style="visibility:visible" class="btn btn-info" value="Register" style="width: 40%;"  required/>
            </div>
            <div align="center">
