...
$select="select * from responses where username='$userid'";
  ...
  * {box-sizing: border-box;}
  ...
  <div class="header">
    ...
    <div class="header-right">
      ...
      <a href="http://localhost/righttime/dashboard.php">Home</a>
      <a  href="http://localhost/righttime/logout.php">LogOut</a>
      ...
      <div class="container container-table">
          ...
          <div class="table-wrapper">
            ...
            <tbody>
              ...
              <?php
              for($i=0;$i<mysqli_num_rows($userinfo);$i++)
              {
                 $data=mysqli_fetch_assoc($userinfo);
                 $quer="select * from requests where id='$data[reqid]'";
                 $userinfo3=$ob->db_read($quer);
                 $data4=mysqli_fetch_assoc($userinfo3);
           ...
           <tr>
             ...
             <?php echo $i+1;?>
           </td><td class="body-item mbr-fonts-style display-7"><?php echo $data4['resource'];?>
           </td><td class="body-item mbr-fonts-style display-7"><?php echo $data['date'];?>
             </td></tr>
            <?php
          }
          ?>
