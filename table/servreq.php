          ...
          <table class="table isSearch" cellspacing="0">
            <thead>
              ...
              <th class="head-item mbr-fonts-style display-7">
                      ...
                      Requested user</th><th class="head-item mbr-fonts-style display-7">
                      Requested Resource</th>
                      </th><th class="head-item mbr-fonts-style display-7">
                      Category</th><th class="head-item mbr-fonts-style display-7">
                      Priority</th><th class="head-item mbr-fonts-style display-7">
                      Requested Date</th><th class="head-item mbr-fonts-style display-7">
                      Status</th></tr>
            </thead>
           ...
           <tr>
              ...
              <td class="body-item mbr-fonts-style display-7"><?php echo $i;?>
           </td>
         </td><td class="body-item mbr-fonts-style display-7"><?php echo $data['username'];?></td>
         <td class="body-item mbr-fonts-style display-7"><?php echo $data['resource'];?></td>
         <td class="body-item mbr-fonts-style display-7"><?php echo $data['category'];?></td>
         <td class="body-item mbr-fonts-style display-7"><?php echo $pr;?></td>
         <td class="body-item mbr-fonts-style display-7"><?php echo $data['date'];?></td>
         <td class="body-item mbr-fonts-style display-7"><?php echo $st;?>
