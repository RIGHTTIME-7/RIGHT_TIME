...
$select="select * from registration where username in (select username from volunteer where verified=1)";
//echo $select;
          ...
          <table class="table isSearch" cellspacing="0">
           ...
           <tr>
            ...
            <?php echo $i;?></td>
             <td class="body-item mbr-fonts-style display-7">
            <?php echo $data['name'];?>
          </td><td class="body-item mbr-fonts-style display-7"><?php echo $data['email'];?></td><td class="body-item mbr-fonts-style display-7"><?php echo $data['phone'];?>
